...
class SocialManager:
    ...
    def create_telegram_message(self, content: Dict) -> str:
        ...
        description = content.get('description', '') or content.get('script', '') or 'Check out this amazing finance content!'
        if len(description) > 200:
            description = description[:200] + '...'
        
        return f"""
🎬 **{content.get('title', 'Finance Content')}**
...
#{' #'.join(content.get('tags', ['finance', 'money']))}
        """