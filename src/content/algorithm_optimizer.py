...
class AlgorithmOptimizer:
    ...
    async def optimize_content_for_algorithm(self, content: Dict) -> Dict:
        """Alias for optimize_for_algorithm to maintain compatibility"""
        return await self.optimize_for_algorithm(content)
