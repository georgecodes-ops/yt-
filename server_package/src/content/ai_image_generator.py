try:
    ...
    import logging
    logging.warning("torch/diffusers not available - AI image generation will be disabled")
...
class AIImageGenerator:
    ...
    def __init__(self, brand_manager=None):
        ...
        if TORCH_AVAILABLE:
            ...
            self.device = "cpu"
            self.logger.warning("AI image generation disabled - torch not available")
    ...
    def _initialize_pipeline(self):
        ...
        if not TORCH_AVAILABLE:
            self.logger.info("AI Image Generator running in fallback mode - torch not available")
            self.pipeline = None
            return
        ...
        try:
            ...
            self.logger.info(f"AI Image Generator initialized on {self.device}")
